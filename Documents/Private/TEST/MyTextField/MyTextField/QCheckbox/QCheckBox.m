...
-(void)resetSkinColor
{
    [self setImage:[UIImage imageNamed:@"t1_checkbox1_unchecked.png"] forState:UIControlStateNormal];
    [self setImage:[UIImage imageNamed:@"t1_checkbox1_checked.png"] forState:UIControlStateSelected];}
